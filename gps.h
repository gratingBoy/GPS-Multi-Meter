...
#define MAIN_DELAY 100          //メインループ待ち時間
#define SEARCH_SIGNAL_TONE 400  // 信号未受信時ビープ音
#define SEARCH_SIGNAL_DELAY 500 // 信号未受信時ビープ音ディレイ
#define GPS_SERIAL 9600         // GPSモジュールとの通信速度

//********** prototype **********
static void play98();              // 起動音ビープ再生
static void signalReceivedBeep();  // 電文未信時ビープ再生
static void SearchingSignalBeep(); // 電文未受信時ビープ再生
